...
MPRINT(UTLOPTS):   OPTIONS OBS=MAX FIRSTOBS=1 lrecl=384 NOFMTERR SOURCE SOURCe2 MACROGEN SYMBOLGEN NOTES NOOVP CMDMAC MLOGIC MPRINT MRECALL MERROR NOCENTER DETAILS SERRO
